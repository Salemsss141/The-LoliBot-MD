const lenguaje = () => { return 'ar' } //انوس عم الكل ⚜️
...
const smsLista1 = () => { return `🌟 معلومات 𝑬𝑴𝑷𝑬𝑹𝑶𝑹𝑨𝑵𝑼𝑺-𝑩𝑶𝑻 🌟`}
...
const smsLista8 = () => { return `🍄 كن ANUS 𝑩𝑶𝑻 🍄`}
...
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *غادر ، من غادر بعد الكلب اصبح زوجت الكلب 🐶 😂* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز 𝑬𝑴𝑷𝑬𝑹𝑶𝑹𝑨𝑵𝑼𝑺 𝑩𝑶𝑻-𝑴𝑫 - 𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 '}
